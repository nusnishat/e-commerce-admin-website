    ...
    return (
        <div className='py-12 bg-gray-100'>
            <div className='mb-20'>
                ...
                <div className='mx-4 mb-8 lg:mx-8 flex justify-between items-center'>
                    <div className='space-y-2'>
                        <h1 className='text-3xl font-bold'>Total Products: {products.length}</h1>
                        <p className='text-gray-700'>Grocery Mart Admin Panel</p>
                    </div>
                    {/* Add product button */}
                    <div>
                        <button
                            className='bg-orange text-white px-4 py-2 rounded-md flex items-center'
                            onClick={toggleModal}
                        >
                            <MdAdd className='inline-block me-2 text-white text-2xl' />Add Product
                        </button>
                    ...
                    <div className='py-8 flex justify-center'>
                        {[...Array(Math.ceil(products.length / itemsPerPage))].map((_, index) => (
                            <button
                                ...
                                className={`mx-1 px-4 py-1 bg-gray-200 rounded-md ${
